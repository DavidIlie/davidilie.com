            ...
            {song !== undefined && (
                ...
                >
                    <div
                        ...
                        className="grid max-w-xl p-5 my-1 overflow-visible duration-200 bg-gray-100 border-2 border-gray-200 shadow-lg cursor-pointer dark:bg-gray-800 dark:border-gray-700 rounded-2xl hover:shadow-xl hoverItem"
                    >
                        <div
                            //@ts-ignore
