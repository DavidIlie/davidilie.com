...
summary: "While working on one of my projects I came across a problem with fetching data such as settings from my backend. The problem was that I didn't want to do the request on every render, just when I wanted it to be fetched."
