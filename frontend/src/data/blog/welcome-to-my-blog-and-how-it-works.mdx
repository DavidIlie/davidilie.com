...
<ThoughtQuote>
    Quick note, this post will cover <strong>one</strong> aspect of this website
    (which is about this blog). However, this website has many other aspects as
    well that I might cover later down the line.
</ThoughtQuote>
