...
<ThoughtQuote>
    Quick note, this blog post will cover only one aspect of this website (which
    is the blog), this website has many other functions as well that I might
    cover on a future date.
</ThoughtQuote>
