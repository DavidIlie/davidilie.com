...
Luckily, I discovered [next-auth](https://next-auth.js.org/) which is my holy grail to getting authentication done. I have integrated both Google and Discord and they both return the information that I would need to keep in my database.

```jsx:src/pages/api/auth/[...nextauth].js
