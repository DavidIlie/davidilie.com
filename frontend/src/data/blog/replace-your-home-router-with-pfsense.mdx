...
<InfoQuote>
    Bridge mode disableds the router and Wi-Fi portions and only leaves the
    mode, exposing it to the first ethernet jack to be able to plugged in to
    another router and so on.
</InfoQuote>
