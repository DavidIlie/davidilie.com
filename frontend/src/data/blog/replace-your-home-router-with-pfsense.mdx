...
This blog post is actually an adapted script to the video on my [youtube](https://www.youtube.com/channel/UC92hn9Y8WcY_5LribMDW8uA) channel. If you don't want to read the post, you can watch the video here:

<div className="flex justify-center blog-image">
    <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/NwNfNV2neVc"
