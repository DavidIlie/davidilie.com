---
title: "Your home router sucks! Replace it with pfSense!"
...
tags: ["Home Network", "pfSense", "Open Source"]
by: { name: "David Alexandru Ilie", avatar: "/images/png/me.png" }
image: "https://s3.davidapps.dev/davidilie-blog/assets/1450fece-7e8d-4603-93f5-48531cd6e736.png"
published: true
---
...
<Image
    src="/images/blog/ont-router.jpg"
...
<Image
    src="/images/blog/home-cluster.png"
...
Latency is the problem?! I knew it. That 50% packet loss must mean there is a problem with my router, or the router on the other end, as later in the call they clarified that the fiber connection is stable.
...
<Image
    src="/images/blog/monitoring-pi.png"
...
<Image
    src="/images/blog/iommu-pci-device.png"
...
-   <span className="text-blue-600">
        Change router to bridge mode to connect to VM
    </span> (This is the one I will talk about)

<InfoQuote>
    Bridge mode disables the built-in router and Wi-Fi portions and only leaves
    the modem, exposing it to the connection to a ethernet port to be able to
    plugged in to another router and so on.
</InfoQuote>
...
<Image
    src="/images/blog/server-wan-lan.jpg"
...
<Image
    src="/images/blog/home-switch.jpg"
...
-   You can add custom plugins like WireGuard or OpenVPN and have them running externally instead of internally
-   You can add custom firewalls like pfBlockerNG which is perfect for blocking requests

and so much more...

Anyways, hope you enjoyed this blog post. This is actually a modified script of a video that I will post of my [channel](https://www.youtube.com/channel/UC92hn9Y8WcY_5LribMDW8uA) soon (keep an eye out for that), I also will start making blog posts for every single video that I post, so that you can have a readable version of my video.
