---
title: "Your home router is too basic! Replace it with pfSense!"
...
Okay okay, no more cheesy paragraphs. Let’s get straight to the point. I’m pretty sure you’ve all seen this little guy around your house somewhere.
...
<InfoQuote>
    Bridge mode switches disabled the router and Wi-Fi modules to
</InfoQuote>

Getting a router into bridge mode can be different for the different models of routers that exists out there.
