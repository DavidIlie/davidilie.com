...
const Device: React.FC<{ device: DeviceProps }> = ({ device }) => {
   return (
      <div className="h-full max-w-[22rem] container p-5 mx-auto overflow-hidden duration-200 bg-gray-100 border-2 border-gray-200 rounded-lg shadow-md min-w-device dark:bg-gray-800 dark:border-gray-700 hoverItem">
