...
I recently discovered [the T3 Stack](https://create.t3.gg) which creates a `Next.js` application containing:
...
Well that was before I discovered [Railway](https://railway.app), which is essentialy Vercel, but orchestrates everything together with Docker (such as a Database, etc.).
